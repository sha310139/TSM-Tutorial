...
def return_something(modality):
    ...
    if modality == 'RGB':
        ...
        root_data = 'something/v1/20bn-something-something-v1-flow'
...
def return_somethingv2(modality):
    ...
    if modality == 'RGB':
        ...
        root_data = 'something/v2/20bn-something-something-v2-flow'
...
def return_dataset(root_path, dataset, modality):
    ...
    root_data = os.path.join(root_path, root_data)
